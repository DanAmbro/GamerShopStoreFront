...
{
    public partial class GamerShopStoreFrontContext : DbContext
    {
        public GamerShopStoreFrontContext()
        {
        }

        public GamerShopStoreFrontContext(DbContextOptions<GamerShopStoreFrontContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=.\\sqlexpress02;Database=GamerShopStoreFront;trusted_connection=true;multipleactiveresultsets=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserDetail>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__UserDeta__1788CC4C130AFA91");
